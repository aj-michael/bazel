...
Incompatible changes:
  ...
  - Skylark: It is an error to shadow a global variable with a local
    ...
    function.
  - Bazel supports Unix domain sockets for communication between its
    client and server again, temporarily, while we diagnose a memory
    leak.
...
Important changes:
  ...
  - Reverts a change that lead to misleading warnings.
